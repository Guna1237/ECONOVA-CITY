...
**Want a heads-up?** Open Sound, then tap Turn sound on. Choose Quiet or Standard and try the preview. You will hear short cues for your turn, payments, trades, city updates and 15 seconds remaining. Every update also appears on screen.
...
Roll, resolve your space, use your Actions, end your turn. Watch your objective and keep enough Credits for landing fees.

Full reference: [Player quick start](PLAYER_QUICK_START.md). Rule authority: [Game design specification](GAME_DESIGN_SPEC.md).
